...
print("1. Adding templates/company_settings.html to Git...")
subprocess.run([git_exe, 'add', 'templates/company_settings.html'], check=True)

print("2. Committing...")
subprocess.run([git_exe, 'commit', '-m', 'Copy exact original dashboard navbar CSS to company_settings.html'], check=True)
...
print("4. Uploading templates/company_settings.html to server 134.209.182.8...")
subprocess.run(['scp', '-i', key_file, '-o', 'StrictHostKeyChecking=no', 'templates/company_settings.html', 'root@134.209.182.8:/var/www/stock_flow/templates/company_settings.html'], check=True)
...
print("ALL DEPLOYMENT STEPS FINISHED SUCCESSFULLY!")
